    ...
    ColumnLayout {
        ...
        Row{
            ...
            Button {
                ...
                anchors.margins: -300
                onClicked: {
                    FileIO.editExistingEntry("ShoppingListData", passedName, FileIO.makeJsonFromFridge(passedName, amountField.text, unitSelector.currentText, noteArea.text/*passedValue, passedUnit, passedNote*/))
                    ShoppingListModel.loadItemsFromFile()
